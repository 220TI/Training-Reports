...
### 目的
上記経路でのネットワーク疎通
    ⇒ ping(8.8.8.8)の疎通で評価する。ゲーム等一部のオンラインコンテンツについては想定しない。
...
> 本機器IPアドレス: 192.168.3.1/24
> IPアドレス: 192.168.3.165 MACアドレス: 72:BF:74:A5:5F:B8 ← C891FJ
...
ファイアウォールの受信の規則でICMPv4を許可する。（作業後削除する）
